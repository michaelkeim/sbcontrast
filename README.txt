...
the pixel size and photometric zeropoint as expected, the user will need to
provide these (via -pix and -zp). Moreover, sbcontrast defaults to a 1sigma,
60 arcsec scale, though other limits may also be specified (via -N and -s).
